...
export const DROPDOWN_ENDPOINTS = ['TASK_TYPES', 'CATEGORIES', 'STATES', 'STATUS', 'PROFILE_TYPES', 'PRODUCT_TYPES', 'PHONE_TYPES', 'ADDRESS_TYPES', 'EMAIL_ADDRESS_TYPES', 'GENDERS', 'TIMEZONES'] as const;
